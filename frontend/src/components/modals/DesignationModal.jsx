...
export const DesignationModal = ({ isOpen, onClose, onSave, designation = null }) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Responsibilities, skills, and expectations for the role"
            />
          </div>
